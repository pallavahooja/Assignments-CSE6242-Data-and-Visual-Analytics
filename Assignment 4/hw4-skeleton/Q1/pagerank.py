...
def author():                                                                                             
        return "psrinivasan48" # replace gburdell3 with your Georgia Tech username.
                                                                                              
def gtid():                                                                                               
    return 903543049 # replace with your GT ID number
    ...
    def run_pagerank(self, node_weights,  damping_factor=0.85, iterations=10):
        ...
        #############################################
            ...
            for i in range(self.max_node_id):
                pr_values[i] += (1-damping_factor)*node_weights[i]
        #############################################
